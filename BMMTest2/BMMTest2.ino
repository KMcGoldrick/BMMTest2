...
int8_t my_bmm150_get_regs(uint8_t reg_addr, uint8_t* reg_data, uint32_t len, struct bmm150_dev* dev)
{
    ...
    my_bmm150_error_codes_print_result("my_bmm150_get_regs: ", rslt);
    return rslt;
}
...
int8_t my_bmm150_set_regs(uint8_t reg_addr, const uint8_t* reg_data, uint32_t len, struct bmm150_dev* dev)
{
    ...
    my_bmm150_error_codes_print_result("my_bmm150_set_regs: ", rslt);
    return rslt;
}

static int8_t my_suspend_to_sleep_mode(struct bmm150_dev* dev)
{
    int8_t rslt;
...
static int8_t my_write_op_mode(uint8_t op_mode, struct bmm150_dev* dev)
{
    int8_t rslt;
    uint8_t reg_data;
...
static uint8_t my_are_settings_changed(uint16_t sub_settings, uint16_t desired_settings)
{
...
static int8_t my_set_control_measurement_xyz(const struct bmm150_settings* settings, struct bmm150_dev* dev)
{
    int8_t rslt;
    uint8_t reg_data;
...
static int8_t my_mode_settings(uint16_t desired_settings, const struct bmm150_settings* settings, struct bmm150_dev* dev)
{
...
static int8_t my_interrupt_pin_settings(uint16_t desired_settings,
...
static int8_t my_interrupt_config(uint16_t desired_settings, const struct bmm150_settings* settings,
    struct bmm150_dev* dev)
{
    int8_t rslt;
    uint8_t reg_data;
...
static int8_t my_interrupt_threshold_settings(uint16_t desired_settings,
    const struct bmm150_settings* settings,
    struct bmm150_dev* dev)
{
    int8_t rslt = BMM150_E_INVALID_CONFIG;
...
static int8_t my_set_xy_rep(const struct bmm150_settings* settings, struct bmm150_dev* dev)
{
    int8_t rslt;
    uint8_t rep_xy;
...
static int8_t my_set_z_rep(const struct bmm150_settings* settings, struct bmm150_dev* dev)
{
    int8_t rslt;
    uint8_t rep_z;
...
static int8_t my_set_odr(const struct bmm150_settings* settings, struct bmm150_dev* dev)
{
    int8_t rslt;
    uint8_t reg_data;
...
static int8_t my_set_odr_xyz_rep(const struct bmm150_settings* settings, struct bmm150_dev* dev)
{
    int8_t rslt;
...
static int8_t my_read_trim_registers(struct bmm150_dev* dev)
{
    int8_t rslt;
